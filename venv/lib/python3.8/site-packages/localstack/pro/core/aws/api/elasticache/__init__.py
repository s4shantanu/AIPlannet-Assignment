...
class ElasticacheApi:
    ...
    def create_cache_cluster(
        ...
        **kwargs,
        ...
        S3.
        :param snapshot_name: The name of a Redis OSS snapshot from which to restore data into the new
        node group (shard).
        ...
        :param auto_minor_version_upgrade: If you are running Redis OSS engine version 6.
    ...
    def decrease_replica_count(
        ...
        **kwargs,
        ...
        shard in a Redis OSS (cluster mode enabled) replication group.
    ...
    def modify_replication_group_shard_configuration(
        ...
        **kwargs,
        ...
        :param replication_group_id: The name of the Redis OSS (cluster mode enabled) cluster (replication
